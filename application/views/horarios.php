  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <label>Inicio:</label>
       <input class="form-control" type="text" id="time1" name="tempo1">
       <label>Fim:</label>
       <input class="form-control" type="text" id="time2" name="tempo2">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-thumb-tack"></i> Adicionar Disciplina
          <div class="modal-body">
